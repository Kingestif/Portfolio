        ...
        <div className="h-screen flex flex-col justify-center bg-black items-center gap-10">
            ...
            <div className="flex gap-10 items-center">
                {projects.map(project=>(
                    <div key={project.id} className="flex flex-col w-110 h-110 items-center text-white gap-3 rounded-2xl bg-gray-500/25">
                        ...
                        <div className="flex gap-5 self-start text-gray-400 px-5 py-3">
                            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer"><ExternalLink/></a>
                            <a href={project.githubUrl} target="_blank" rel="noopener noreferrer"><Github/></a>
                        </div>
                    </div>
                ))}
            </div>
            <a href="https://github.com/Kingestif" target="_blank" rel="noopener noreferrer" className="flex gap-2 bg-yellow-700 rounded-full py-2 px-3">
                <div className="text-white font-bold">Check my Github</div>
