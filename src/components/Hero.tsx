    ...
    return (
        <div className="pt-40 flex  justify-between text-white/90 fade-in-down | max-sm:pt-0">
            <div className="Left w-1/2 flex flex-col gap-10 pt-7 | max-sm:w-fit max-sm:gap-5">
                ...
                <div className="text-xl text-gray-300 | max-sm:text-base max-sm:w-full w-fit">Full-Stack Software Engineer specializing in building scalable web and mobile applications. I create seamless, user-friendly, and high-performance digital solutions.</div>
                <div className="flex gap-10 mt-20">
                    ...
                    <a href="https://t.me/stiv_o" target="_blank" className="p-0.5 bg-gradient-to-t from-pink-700 to-purple-600 rounded-full hover:scale-110 duration-300">
                ...
                <div className="mt-2xl flex gap-10 text-xl text-white/80 whitespace-nowrap | max-sm:text-base max-sm:whitespace-nowrap">
                    ...
                    <a href="#contact" className="  rounded-full py-3 px-4 flex items-center bg-gradient-to-t from-pink-700 to-purple-600 hover:text-white duration-300 | max-sm:text-xs max-sm:py-2 max-sm:px-2">Contact Me</a>
                </div>
            </div>
            <img className="Right w-170 h-170 | max-sm:hidden" src="/HeroRight.svg" alt="" />
        </div>
    )
}