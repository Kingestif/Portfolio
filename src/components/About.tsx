            ...
            <div className="Left flex flex-col gap-30 ">
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flex flex-col gap-5 text-gray-300">
                        <div className="font-medium text-xl text-white | w-fit bg-blue-400 max-sm:whitespace-nowrap">Estifanos Zinabu</div>
                        <div className="text-xl max-sm:w-screen w-fit"> Software Developer with over 3 years of experience specializing in Frontend, Backend, and Mobile App Development. I can design and build scalable, user-friendly applications from concept to deployment, leveraging modern technologies and clean architecture principles. My greatest strength is the ability to quickly adapt to new tools and frameworks, ensuring high-quality, maintainable solutions while collaborating effectively across multidisciplinary teams. </div>
                    </div>
                </div>
            </div>
