            ...
            <div className=" p-10 rounded-2xl shadow-xl border border-white/30">
                ...
                <form className="flex flex-col gap-6">
                    ...
                    >
                        ...
                        <button className="bg-purple-600 hover:bg-purple-700 transition-colors p-4 rounded-lg font-semibold text-lg max-sm:text-base">
                        Send Message
                    </button>
                </form>
            </div>
